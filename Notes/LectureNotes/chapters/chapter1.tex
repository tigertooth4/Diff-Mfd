...
\warnernumber{1}
\discuss{1.1}{Some Basic Notation and Terminology}\label{thm:1.1} Throughout this text we will describe sets either by listings of their elements, for example
\[
	\{a_{1},\ldots,a_{n}\},
\]
