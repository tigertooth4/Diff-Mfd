...
\subsection{Some Basic Notation and Terminology}\label{thm:1.1}
%\discuss{1.1}\phantomsection\label{thm:1.1}{Some Basic Notation and Terminology}

Throughout this text we will describe sets either by listings of their elements, for example
\[
	\{a_{1},\ldots,a_{n}\},
\]
...
We will denote the empty set by $\varnothing$. We will often denote a collection $\{U_a : \alpha \in A\}$
of sets $U_a$ indexed by the set $A$ simply by $\{U_a\}$ if explicit mention of
the index set is not necessary. The union of the sets in the collection
$\{U_a : \alpha \in A\}$ will be denoted $\bigcup_{a \in A} U_a$ or simply
$\bigcup U_a$. Similarly, their intersection will be denoted $\bigcap_{a \in A} U_a$
or simply $\bigcap U_a$.
\[
	\bigcup_{\alpha\in A}U_{\alpha}=\{a\colon a\text{ belongs to some }U_{\alpha}\}.
\]
\[
	\bigcap_{a\in A}U_{a}=\{a\colon a\text{ belongs to every }U_{a}\}.
\]
...
\begin{center}
	\includegraphics[width=0.20\textwidth]{figures/ch1_img_in_image_box_394_882_575_1063.jpg}
\end{center}
...
\subsection{\quad}\label{thm:1.12}
%\discuss{1.12}\phantomsection\label{thm:1.12}{}
...
\begin{equation}
	\label{eq:1.12:2}%\tag{2}\hypertarget{eq:1.12:2}{}
...
\begin{definition}\label{thm:1.13}
	...
	$germs$, and we denote the set of germs at $m$ by $\widetilde{F}_m$.
\end{definition}
...
\subsection{\quad}\label{thm:1.15}
%\discuss{1.15}\phantomsection\label{thm:1.15}{} 
...
\subsection{\quad}
%\discuss{1.18}\phantomsection\label{thm:1.18}{} 
...
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/ch1_img_in_image_box_142_360_796_574.jpg}
\end{center}
...
\subsection{\quad}\label{thm:1.21}
...
\subsection{The Differential}\label{thm:1.22}
...
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/ch1_img_in_image_box_193_1012_798_1161.jpg}
\end{center}
...
\subsection{Tangent and Cotangent Bundles}\label{thm:1.25}
...
Let $(U,\varphi)\in\mathcal{F}$ with coordinate functions $x_1,\ldots,x_d$. Define $\tilde{\varphi}\colon\pi^{-1}(U)\to\mathbb{R}^{2d}$ and $\tilde{\varphi}^{*}\colon(\pi^{*})^{-1}(U)\to\mathbb{R}^{2d}$ by
...
\subsection{Higher Order Tangent Vectors and Differentials}\label{thm:1.26}\footnote{The material of this section will not be used elsewhere in the book, and so it may be skipped without loss of continuity.}
...
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/ch1_img_in_image_box_128_118_775_372.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/ch1_img_in_image_box_173_372_781_655.jpg}
\end{center}
\end{proof}
...
\subsection{\quad}\label{thm:1.31}
...
\begin{center}
\includegraphics[width=0.44\textwidth]{figures/ch1_img_in_image_box_153_1038_578_1216.jpg}
\end{center}

\begin{center}
\includegraphics[width=0.20\textwidth]{figures/ch1_img_in_image_box_615_1044_813_1171.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.20\textwidth]{figures/ch1_img_in_image_box_346_196_547_325.jpg}
\end{center}
...
\subsection{Further Remarks on Submanifolds}\label{thm:1.33}
...
\begin{center}
\includegraphics[width=0.21\textwidth]{figures/ch1_img_in_image_box_345_900_553_1026.jpg}
\end{center}
...
\subsection{Slices}\label{thm:1.34}
...
\begin{equation}
\label{eq:1.34:1}
S=\{q\in U\colon x_{i}(q)=x_{i}(a),i=c+1,\ldots,d\}.
\end{equation}
...
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/ch1_img_in_image_box_122_729_777_1178.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/ch1_img_in_image_box_131_248_790_491.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.58\textwidth]{figures/ch1_img_in_image_box_158_769_735_1115.jpg}
\end{center}
\end{theorem}
...
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/ch1_img_in_image_box_104_579_763_916.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/ch1_img_in_image_box_133_752_767_1159.jpg}
\end{center}
...
\subsection{Lie Bracket}\label{thm:1.44}
...
\subsection{\quad}\label{thm:1.47}
...
\begin{center}
\includegraphics[width=0.27\textwidth]{figures/ch1_img_in_image_box_318_101_583_300.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.41\textwidth]{figures/ch1_img_in_image_box_294_558_684_923.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.60\textwidth]{figures/ch1_img_in_image_box_173_247_798_592.jpg}
\end{center}
...
\begin{equation}
\label{eq:1.62:1}\includegraphics[width=0.21\textwidth]{figures/ch1_img_in_image_box_351_351_552_477.jpg}
\end{equation}
...
\begin{center}
\includegraphics[width=0.29\textwidth]{figures/ch1_img_in_image_box_316_422_604_490.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.32\textwidth]{figures/ch1_img_in_image_box_503_282_816_506.jpg}
\end{center}
...
\begin{center}
\includegraphics[width=0.20\textwidth]{figures/ch1_img_in_image_box_336_889_529_1014.jpg}
\end{center}
