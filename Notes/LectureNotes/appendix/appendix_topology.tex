...
\begin{example}
	...
	\begin{figure}[!ht]
		\centering
		\redrawn{figure-44}
    \caption{A relatively open set (redrawn after
...
\begin{figure}[htbp]
	\centering
	\redrawn{figure-45}
	\caption{The criterion for a basis, redrawn after \cite{tu_introduction_2011}}
...
\begin{figure}[htbp]
	\centering
	\redrawn{figure-46}
	\caption{The Hausdorff condition and normality, redrawn after
		\cite{tu_introduction_2011}}
...
\begin{figure}[ht]
	\centering
	\redrawn{figure-48}
	\caption{Gluing the edges of a square (redrawn after
		\cite{tu_introduction_2011})}
...
\begin{example}
	...
	\begin{figure}[ht]
		\centering
		\redrawn{figure-49}
		\caption{The unit circle as a quotient of the unit interval (redrawn
...
\begin{figure}[ht]
	\centering
	\redrawn{figure-50}
	\caption{A projection map that is not open (redrawn after
		\cite{tu_introduction_2011})}
...
\begin{figure}[ht]
	...
	\caption{The graph $R$ of an equivalence relation and an open set
		$U\times V$ disjoint from $R$ (redrawn after
		\cite{tu_introduction_2011})}
